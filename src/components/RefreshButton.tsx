...
function RefreshButton({ onClick }: Props) {
  return (
    <RefreshButtonWrapper
      ...
      whileTap='pressed'
    >
      <Arrow width='16' height='16' xmlns='http://www.w3.org/2000/svg' variants={arrow}>
        <path
...
const RefreshButtonWrapper = styled(motion.button)`
  ${({ theme }) => css`
    position: absolute;
    border: 1px dotted ${theme.palette.gray50};
    border-radius: 5px;
    padding: 5px;
    width: 20px;
    height: 20px;
